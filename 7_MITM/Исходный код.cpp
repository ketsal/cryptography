...
#include <mutex>
std::mutex locker;
void ResultOfEncryption(std::map <  std::vector<unsigned char>, std::string > &MAP, unsigned char **KEYS, std::vector<unsigned char> data, int start, int end, int DecOrEnc)
{
    DesProxy DoubleDES;
